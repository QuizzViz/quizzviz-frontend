...
//                 onEnd={handleProctoringEnd}
//                 isActive={true}
//                 startDetection={quizStarted && !hasSubmittedRef.current}
//               />
//             </div>
...
//                         {calculateScore().percentage >= 70 
//                           ? 'You have successfully completed the quiz with a great score.'
//                           : calculateScore().percentage >= 50 
...
//                   <div className="text-center">
//                     <Link href="/">
//                       <Button className="h-12 px-8 bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-medium rounded-xl transition-all duration-200">
