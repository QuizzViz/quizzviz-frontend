...
//   const [formData, setFormData] = useState<FormData>({ name: '', email: '', quizKey: '' });
//   const [quizData, setQuizData] = useState<QuizData | null>(null);
//   const [userPlan] = useState<'Free' | 'Consumer' | 'Business'>('Free');
//   const [currentQuestionIndex, setCurrentQuestionIndex] = useState<number>(0);
//   const [selectedAnswers, setSelectedAnswers] = useState<Record<number, string>>({});
//   const [isButtonLoading, setIsButtonLoading] = useState<boolean>(false);
//   const [timeLeft, setTimeLeft] = useState<number>(0);
...
//   const handleFullscreenChange = useCallback(async () => {
//     if (isSubmittingRef.current || exitConfirmationRef.current || !quizStarted || isRestoring) return;
...
//   // FIXED: Consolidated calculateResults function
//   const calculateResults = useCallback(() => {
//     const showCorrectAnswers = userPlan === 'Free' || userPlan === 'Consumer';
    
//     if (!quizData) return { correct: 0, total: 0, percentage: 0, showCorrectAnswers };
...
//     return { correct, total, percentage, showCorrectAnswers };
//   }, [quizData, selectedAnswers, userPlan]);
...
//   const checkUserAttemptsAfterLoad = useCallback(async (maxAttempts: number): Promise<boolean> => {
//     if (!formData?.name || !formData?.email) {
//       return false;
//     }
...
//     if (userPlan === 'Free' || userPlan === 'Consumer') {
//       try {
//         setVerifying(true);
//         setVerificationError('');
...
//         const shuffledQuiz = {
//           ...data,
//           quiz: data.quiz ? shuffleArray([...data.quiz]) : []
//         };
...
//         setVerificationError('Failed to load quiz. Please try again.');
...
//   // FIXED: Added beginQuiz function
//   const beginQuiz = useCallback(async () => {
//     if (userPlan === 'Free' || userPlan === 'Consumer') {
//       setQuizStarted(true);
//       setStep('quiz');
...
//       setIsButtonLoading(false);
//     }
//   }, [checkUserAttempts, attemptsInfo, isButtonLoading, requestFullscreen, userPlan]);
