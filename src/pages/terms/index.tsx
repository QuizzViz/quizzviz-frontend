      ...
      <main className="flex-grow mt-12 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="bg-card rounded-xl shadow-sm p-8 text-foreground">
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">
              QuizzViz provides an online platform for creating, sharing, and taking quizzes. The service allows users to generate visual insights from quiz results.
            </p>
          </section>

          <section className="mb-10">
            <h2 className="text-2xl font-semibold mb-4">3. User Accounts</h2>
            <p className="mb-4">To access certain features, you may be required to create an account. You are responsible for maintaining the confidentiality of your account information.</p>
          </section>

          <section className="mb-10">
            <h2 className="text-2xl font-semibold mb-4">4. User Content</h2>
            <p className="mb-4">You retain ownership of any content you create or upload to QuizzViz. By submitting content, you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, and display such content in connection with the service.</p>
          </section>
