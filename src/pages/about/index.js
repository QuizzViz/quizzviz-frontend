...
const FeatureCard = ({ icon: Icon, title, children, className = '' }) => (
  <div className={`p-6 rounded-xl border bg-card/50 backdrop-blur-sm ${className}`}>
    ...
    <>
      ...
      <div className="min-h-screen bg-background text-white">
        ...
        <section className="relative overflow-hidden py-20 md:py-32">
          <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22%3E%3Ccircle cx=%2250%22 cy=%2250%22 r=%2220%22 fill=%22none%22 stroke=%22rgba(0,200,83,0.1)%22 stroke-width=%222%22/%3E%3C/svg%23')] opacity-20" />
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="text-center space-y-6">
              <span className="inline-block px-4 py-2 rounded-full bg-teal-500/10 text-teal-300 text-sm font-medium">
                Our Mission
              </span>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight">
                Empowering <span className="text-teal-300">Learning</span> and <span className="text-teal-300">Hiring</span>
              </h1>
        ...
        <section className="py-20 max-w-6xl mx-auto px-6">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-14 h-14 bg-green-500/20 rounded-xl flex items-center justify-center">
              <Code className="w-7 h-7 text-teal-300" />
            </div>
            <h2 className="text-4xl font-bold">For Learners</h2>
          </div>
          
          <div className="space-y-8">
            <div className="bg-green-900/50 backdrop-blur-sm border rounded-2xl p-8 md:p-10 space-y-6">
              <h3 className="text-2xl font-semibold text-teal-300">The Real Test of Knowledge</h3>
            ...
            <div className="bg-green-900/50 backdrop-blur-sm border rounded-2xl p-8 md:p-10 space-y-6">
              <h3 className="text-2xl font-semibold text-teal-300">A Clear Mirror of Your Knowledge</h3>
              <p className="text-gray-300 leading-relaxed">
              ...
              <div className="mt-6 p-6 bg-teal-500/20 border border-teal-500/30 rounded-xl">
        ...
        <section className="py-20 bg-background">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="bg-green-900/50 backdrop-blur-sm border border-green-800/30 rounded-2xl p-8 md:p-10 space-y-6">
              <h3 className="text-2xl font-semibold text-teal-300">The Broken Hiring System</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="bg-green-900/50 backdrop-blur-sm border border-green-800/30 rounded-2xl p-8 md:p-10 space-y-6">
              <h3 className="text-2xl font-semibold text-teal-300">The QuizzViz Approach</h3>
              <p className="text-gray-300 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-6">
                <div className="p-6 bg-teal-500/20 border border-teal-500/30 rounded-xl">
                  <h4 className="text-xl font-semibold mb-3 text-teal-200">Instant Filtering</h4>
                ...
                <div className="p-6 bg-teal-500/20 border border-teal-500/30 rounded-xl">
                  <h4 className="text-xl font-semibold mb-3 text-teal-200">Time Savings</h4>
                ...
                <div className="p-6 bg-teal-500/20 border border-teal-500/30 rounded-xl">
                  <h4 className="text-xl font-semibold mb-3 text-teal-200">Smaller HR Teams</h4>
                ...
                <div className="p-6 bg-teal-500/20 border border-teal-500/30 rounded-xl">
                  <h4 className="text-xl font-semibold mb-3 text-teal-200">Complete Analytics</h4>
          ...
          <div className="relative overflow-hidden rounded-3xl mt-20">
            <div className="absolute inset-0 bg-gradient-to-r from-green-700 via-teal-700 to-blue-700 opacity-90" />
            <div className="relative px-8 py-16 md:px-12 md:py-20 space-y-6">
              ...
              <h2 className="text-4xl font-bold text-center mb-6">What We Stand For</h2>
              <p className="text-xl text-gray-100 leading-relaxed max-w-3xl mx-auto text-center">
