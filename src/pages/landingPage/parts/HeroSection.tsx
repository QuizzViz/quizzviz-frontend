...
const HeroSection: FC = () => {
  ...
  return (
    <section id="hero" className="relative flex items-center justify-center overflow-hidden pt-8 sm:pt-10 md:pt-16 lg:pt-20 pb-16 sm:pb-20 scroll-mt-20 sm:scroll-mt-24 md:scroll-mt-28">
