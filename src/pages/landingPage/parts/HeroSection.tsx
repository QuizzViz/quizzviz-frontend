...
const HeroSection: FC = () => {
  ...
  return (
    <section id="hero" className="relative flex items-center justify-center min-h-screen overflow-hidden pt-[58px] sm:pt-16 md:pt-[72px] lg:pt-20 pb-16 sm:pb-20 scroll-mt-20 sm:scroll-mt-24 md:scroll-mt-28">
      ...
      <div className="relative z-10 max-w-7xl mt-2 lg:mt-12 mx-auto px-4 sm:px-6 lg:px-8">
