...
const HeroSection: FC = () => {
  ...
  return (
    <section id="hero" className="relative flex items-center justify-center min-h-screen overflow-hidden pt-14 sm:pt-16 pb-16 sm:pb-20 scroll-mt-20 sm:scroll-mt-24 md:scroll-mt-28">
