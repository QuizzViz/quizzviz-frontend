...
const FeatureCard = ({ icon: Icon, title, children, className = '' }) => (
  <div className={`p-8 rounded-2xl bg-gradient-to-br from-card to-card/80 border border-border/30 backdrop-blur-sm transition-all hover:border-primary/40 hover:shadow-lg ${className}`}>
        ...
        <section className="relative overflow-hidden py-20 md:py-32">
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="text-center space-y-6">
              <span className="inline-block px-5 py-2.5 rounded-full bg-gradient-to-r from-primary/10 to-primary/5 text-primary text-sm font-semibold border border-primary/20 backdrop-blur-sm">
                Our Mission
              </span>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white">
                Empowering <span className="bg-gradient-to-r from-blue-400 to-green-400 bg-clip-text text-transparent">Learning</span> and{' '}
                <span className="bg-gradient-to-r from-blue-400 to-green-400 bg-clip-text text-transparent">Hiring</span>
              </h1>
          ...
          <div className="max-w-6xl mx-auto px-6 mt-12 space-y-8">
            <div className="bg-gradient-to-br from-card to-card/90 backdrop-blur-sm border border-border/30 rounded-2xl p-8 md:p-10 space-y-6 transition-all hover:border-primary/40 hover:shadow-lg">
              <h3 className="text-2xl font-semibold text-white">The Real Test of Knowledge</h3>
            ...
            <div className="bg-gradient-to-br from-card to-card/90 backdrop-blur-sm border border-border/30 rounded-2xl p-8 md:p-10 space-y-6 transition-all hover:border-primary/40 hover:shadow-lg">
              <h3 className="text-2xl font-semibold text-primary">A Clear Mirror of Your Knowledge</h3>
              <p className="text-foreground/80 leading-relaxed">
              ...
              <div className="mt-6 p-6 bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-xl backdrop-blur-sm">
        ...
        <section className="py-20 bg-background">
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center gap-4 mb-8">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center border border-primary/20">
            ...
            <div className="bg-gradient-to-br from-card to-card/90 backdrop-blur-sm border border-border/30 rounded-2xl p-8 md:p-10 space-y-6 transition-all hover:border-primary/40 hover:shadow-lg">
              <h3 className="text-2xl font-semibold text-white">The Broken Hiring System</h3>
              <p className="text-foreground/80 leading-relaxed">
                We believe the current hiring system is fundamentally broken. Here's how it typically works:
              </p>
              <div className="space-y-4 ml-6 border-l-2 border-primary/30 pl-6">
                <div className="space-y-2">
                  <p className="text-foreground font-medium">Step 1: Resume Screening</p>
                ...
                <div className="space-y-2">
                  <p className="text-foreground font-medium">Step 2: Home Assignments</p>
                ...
                <div className="space-y-2">
                  <p className="text-foreground font-medium">Step 3: Interviews</p>
            ...
            <div className="mt-12 bg-gradient-to-br from-card to-card/90 backdrop-blur-sm border border-border/30 rounded-2xl p-8 md:p-10 space-y-6 transition-all hover:border-primary/40 hover:shadow-lg">
              <h3 className="text-2xl font-semibold text-white">The QuizzViz Approach</h3>
              <p className="text-foreground/80 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-6">
                <div className="p-6 bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl backdrop-blur-sm">
                  <h4 className="text-xl font-semibold mb-3 text-white">Instant Filtering</h4>
                ...
                <div className="p-6 bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl backdrop-blur-sm">
                  <h4 className="text-xl font-semibold mb-3 text-white">Time Savings</h4>
                ...
                <div className="p-6 bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl backdrop-blur-sm">
                  <h4 className="text-xl font-semibold mb-3 text-white">Smaller HR Teams</h4>
                ...
                <div className="p-6 bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl backdrop-blur-sm">
                  <h4 className="text-xl font-semibold mb-3 text-white">Complete Analytics</h4>
          ...
          {/* Our Core Belief */}
          <div className="relative overflow-hidden rounded-3xl mt-20 bg-gradient-to-r from-primary/10 via-card/80 to-primary/10 border border-border/20">
            <div className="relative px-8 py-16 md:px-12 md:py-20 space-y-6">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-card/80 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-border/50">
                  <Lightbulb className="w-8 h-8 text-primary" />
                </div>
              </div>
              <h2 className="text-4xl font-bold text-center mb-6 text-foreground">What We Stand For</h2>
              <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl font-semibold text-center mt-8 text-primary">
