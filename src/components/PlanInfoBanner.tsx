...
export function PlanInfoBanner() {
  ...
  if (planType === 'Business') {
    return (
      <div className="p-4 bg-blue-900/20 border border-blue-700/30 rounded-lg text-sm text-blue-200">
        <p>You're on the <Link href="/pricing" className="font-semibold underline">Business Plan</Link> with access to all features including {planLimits.maxQuestions} questions per quiz, {planLimits.maxQuizzes} quizzes per month, and advanced analytics.</p>
      </div>
    );
  }
